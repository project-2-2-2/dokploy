				...
				>
					...
					<div className="text-[16px]">
						<button
							...
							className="px-[1.125em] py-2 rounded-full bg-[#504c4c] text-white"
						>
							Login
						</button>
						<button
							onClick={() => (window.location.href = "/register")}
							className="px-[1.125em] py-2 bg-neon text-black"
						>
							SignUp
						</button>
					</div>
				...
				>
					...
					<motion.div className="flex-1 h-full bg-darkgray rounded-md flex flex-col justify-between relative text-center items-center p-8 text-white/80 overflow-hidden ">
						...
						<div className="flex flex-col items-center gap-4 z-10 -mt-15">
							...
							<button
								onClick={() => (window.location.href = "/login")}
								className="bg-bg font-extralight text-black px-4 py-2 rounded text-lg = hover:bg-gray-200 transition-colors"
							>
								Join them
							</button>
						</div>
