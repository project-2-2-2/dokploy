...
const TEMPLATE_BASE_URL_KEY = "Gocker_template_base_url";
								...
								{templates?.map((template, idx) => (
									...
									>
										...
										>
											...
											<img
												src={`${customBaseUrl || "https://templates.Gocker.com/"}/blueprints/${template?.id}/${template?.logo}`}
												className={cn(
													"object-contain",
